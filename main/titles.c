...
briefing_screen Briefing_screens_full[] = {
	...
	{ "jup01.pcx",    11, 18,  10, 64, 300,  200 }, // level 11
	{ "jup01.pcx",    12, 19,  10, 64, 300,  200 }, // level 12
	{ "brief03.pcx",  13, 20,  20,  22, 257, 177 },
	{ "jup01.pcx",    13, 21,  10, 64, 300,  200 }, // level 13
	{ "jup01.pcx",    14, 22,  10, 64, 300,  200 }, // level 14
	{ "saturn01.pcx", 15, 23,  10, 64, 300,  200 }, // level 15
	{ "brief03.pcx",  16, 24,  20,  22, 257, 177 },
	{ "saturn01.pcx", 16, 25,  10, 64, 300,  200 }, // level 16
	{ "brief03.pcx",  17, 26,  20,  22, 257, 177 },
	{ "saturn01.pcx", 17, 27,  10, 64, 300,  200 }, // level 17
	...
	{ "aster01.pcx",  -3, 64,  10, 90, 300,  200 }, // secret level -3
	{ "end01.pcx",   ENDING_LEVEL_NUM_OEMSHARE,  1,  23, 64, 320, 200 },   //  OEM and shareware end
	{ "end02.pcx",   ENDING_LEVEL_NUM_REGISTER,  1,  5, 5, 300, 200 },    // registered end
	{ "end01.pcx",   ENDING_LEVEL_NUM_REGISTER,  2,  23, 64, 320, 200 },  // registered end
...
briefing_screen Briefing_screens_share[] = {
	...
	{ "end01.pcx",   ENDING_LEVEL_NUM_OEMSHARE,  1,  23, 64, 320, 200 }, // shareware end
};
...
{
	Briefing_text_colors[0] = gr_find_closest_color_current( 0, 64, 0);
...
static int load_briefing_screen(briefing *br, char *fname)
{
	...
	if (SWIDTH >= 640 && SHEIGHT >= 480 && (strstr(forigin,"descent.hog") != NULL))
	{
		...
		if ((ptr = strrchr(fname2,'.')))
			*ptr = '\0';
		strncat(fname2, "h.pcx", sizeof(fname2) - strlen(fname2) - 1);
